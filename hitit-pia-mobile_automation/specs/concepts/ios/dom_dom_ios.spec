...
OW - DOM_DOM - 1 ADT, 1 CHD, 1 INF
------------------------------
tags:ow_dom_dom_1adt_1chd_1inf_ios
...
RT - DOM_DOM - 1 ADT
--------------------
tags:rt_dom_dom_1adt_ios

* Select book a flight ios
* Select from "karachi" port
* Select to "gilgit" port
* Select departure and return flight
* Wait "3" seconds if iOS
* Select economy
* Click book now button
 Select flight
...
RT - DOM_DOM - 1 ADT, 1 CHD, 1 INF
----------------------------------
tags:rt_dom_dom_1adt_1chd_1inf_ios
